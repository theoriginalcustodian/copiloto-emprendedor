...
describe('Rail', () => {
  ...
  it('renderiza los 14 ítems del registro declarativo (Chat · Apps · Conexiones · Gastos · Clientes · Contabilidad · Ingresos · Actividad · Presupuestos · Inteligencia · Mi día · Funciones · Recientes · Cuenta)', () => {
    renderRail();
