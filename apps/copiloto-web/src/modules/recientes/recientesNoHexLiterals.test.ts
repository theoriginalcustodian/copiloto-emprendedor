...
import recientesCss from './recientes.css?raw';
import recientesScreenSource from './RecientesScreen.tsx?raw';

/**
 * Gate "cero color literal" (Global Constraint del plan: "Ningún componente usa color literal —
 * todo token"), acotado al módulo Recientes. Mismo criterio que
...
const SOURCES: Record<string, string> = {
  'recientes.css': recientesCss,
  'RecientesScreen.tsx': recientesScreenSource,
};

describe('módulo recientes — cero color literal (hex)', () => {
