...
import midiaScreenSource from './MidiaScreen.tsx?raw';

/**
 * Gate "cero color literal" (Global Constraint del plan: "Ningún componente usa color literal —
 * todo token"), acotado a mi ownership de este Task (módulo Midia). Mismo criterio que
...
const SOURCES: Record<string, string> = {
  'midia.css': midiaCss,
  'MidiaScreen.tsx': midiaScreenSource,
};

describe('módulo midia — cero color literal (hex)', () => {
