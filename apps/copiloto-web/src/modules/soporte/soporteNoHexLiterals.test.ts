...
import miTicketCss from './miTicket.css?raw';
import soporteScreenSource from './SoporteScreen.tsx?raw';
import miTicketScreenSource from './MiTicketScreen.tsx?raw';
import composerSoporteSource from './ComposerSoporte.tsx?raw';

/**
 * Gate "cero color literal" (Global Constraint del plan: "Ningún componente usa color literal —
 * todo token"), acotado al módulo Soporte. Mismo criterio que
...
const SOURCES: Record<string, string> = {
  'miTicket.css': miTicketCss,
  'SoporteScreen.tsx': soporteScreenSource,
  'MiTicketScreen.tsx': miTicketScreenSource,
  'ComposerSoporte.tsx': composerSoporteSource,
};

describe('módulo soporte — cero color literal (hex)', () => {
