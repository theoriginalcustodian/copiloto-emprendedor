...
import contabilidadCss from './contabilidad.css?raw';
import contabilidadScreenSource from './ContabilidadScreen.tsx?raw';

/**
 * Gate "cero color literal" (Global Constraint del plan: "Ningún componente usa color literal —
 * todo token"), acotado a mi ownership de este Task (módulo Contabilidad). Mismo criterio que
...
const SOURCES: Record<string, string> = {
  'contabilidad.css': contabilidadCss,
  'ContabilidadScreen.tsx': contabilidadScreenSource,
};

describe('módulo contabilidad — cero color literal (hex)', () => {
