...
| (3) **Escucha a pantalla completa en terracota** como único momento display de la UI | ⛔ **DEROGADO** (30/08, decisión de Martin) | La escucha a pantalla completa **dejó de existir** el 24/08: el gesto de voz pasó al patrón de WhatsApp y grabar ya no tapa nada. **Pero la cláusula no se cae por falta de superficie: se cae porque su función ya migró.** El veredicto pedía *un golpe de color diario que fuera la impresión de marca*, y eso hoy lo hace el **bloque negro** — aparece en 9 pantallas y la renovación del 19/08 ya lo había escrito: *"el golpe de color no viene de la paleta: viene del bloque negro"*. El momento display no perdió contenido, **cambió de portador**. ⚠️ Splash y entrada siguen siendo terracota plena, pero **no cumplen lo que el veredicto pedía**: el splash se ve una vez en la vida de la cuenta |
