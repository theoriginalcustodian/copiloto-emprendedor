...
| Escritorio | **6 funciones en grilla de 3×2, sin bandas** (rev. 20/08), sin scroll horizontal | Hick-Hyman castiga los conjuntos equiprobables: 9 tiles iguales son una decisión entre nueve. **Bajar a 6 resuelve el grueso.** ⚠️ Las bandas *Registrar / Mirar* existían para partir esa decisión en dos, pero **al unificarse Contabilidad con Inteligencia (20/08) quedaron en 5 y 1** — dejaron de partir nada, y elegir entre 5 no es más fácil que entre 6. Orden por **frecuencia**, no por categoría | 9 tiles con scroll horizontal (build actual): la affordance más débil de mobile, compitiendo con el gesto vertical del panel y partiendo labels a la mitad |
