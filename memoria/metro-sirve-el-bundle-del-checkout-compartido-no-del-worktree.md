...
description: Verificaste en device y no ves tu cambio pese a tenerlo cherry-pickeado en el worktree — Metro sirve desde el checkout compartido, no desde donde creés; el falso negativo se lee como "el fix no funciona"
metadata:
  type: project
---
