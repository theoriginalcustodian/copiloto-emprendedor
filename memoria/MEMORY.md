...
- **🔴 EN CURSO — PR #162 (RLS real).** **LEER `Manejo de errores/05-ESTADO-VIVO-rls-y-fases.md` AL RETOMAR.** 98 tests rojos **a propósito**: el RLS ya frena escrituras sin tenant. [[rls-activado-que-no-filtraba-el-dueno-esta-exento]]
